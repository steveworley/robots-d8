...
use Drupal\robots\RobotInterface;
 ...
 * )
 */
class Robot extends ContentEntityBase implements RobotInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    $fields['id'] = BaseFieldDefinition::create('integer')
      ->setLabel(t('ID'))
      ->setDescription(t('The ID of the Robot entity.'))
      ->setReadOnly(TRUE);

    $fields['uuid'] = BaseFieldDefinition::create('uuid')
      ->setLabel(t('UUID'))
      ->setDescription(t('The UUID of the Robot entity.'))
      ->setReadOnly(TRUE);

    $fields['user_id'] = BaseFieldDefinition::create('entity_reference')
      ->setLabel(t('Authored by'))
      ->setDescription(t('The user ID of author of the Robot entity.'))
    ...
    $fields['name'] = BaseFieldDefinition::create('string')
      ->setLabel(t('Name'))
      ->setDescription(t('The name of the Robot entity.'))
      ->setSettings(array(
        'max_length' => 50,
        'text_processing' => 0,
      ))
    ...
    $fields['langcode'] = BaseFieldDefinition::create('language')
      ...
      ->setDescription(t('The language code for the Robot entity.'));
